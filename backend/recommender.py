...
def process_query(
    ...
    return {
        "message": _generate_message(intent, enriched, user_message),
        "reply": _generate_message(intent, enriched, user_message),
...
def _generate_message(intent: str, products: list, query: str) -> str:
